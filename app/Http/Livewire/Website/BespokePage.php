...
class BespokePage extends Component
{
    public function render()
    {
        ...
        ->get();
        return view('livewire.website.bespoke-page', compact('venue_obj', 'courses_lists'))->layout('layouts.web_innerPage');
    }
    public function BespokeSubmit(Request $request)
    {
        ...
        if ($validator->fails()) {
            return back()->with('Bespoke_Not_Form', 'Validations Error!');
        }
